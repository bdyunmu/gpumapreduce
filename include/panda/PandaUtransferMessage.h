#ifndef __PANDA_UtransferMessage_H__
#define __PANDA_UtransferMessage_H__
...
namespace panda
{
  ...
  class PandaUtransferMessage : public PandaMessage
  {
    protected:
  ...
  public:
	PandaUtransferMessage();
	PandaUtransferMessage(const bool pCopySendData = false);
	virtual ~PandaUtransferMessage();
